...
BEGIN OPTIONS
   ...
   CUMULATIVE_RESIDUAL_ERROR_ARRAY  ./output/owhm_v1_example_a_Cumulative_Residual_Error.txt    # Print cumulative residual mass error for the entire model grid at the end of the simulation
   PRINT_ITERATION_INFO             ./output/owhm_v1_example_a_Iteration_Info.txt               # Print iteration count and mass error for every time step 
   PRINT_PROPERTY                   ./output/example_a_aquifer_property                         # Print aquifer properties to specified directory
   #
   BUDGETDB                ./output/owhm_v1_example_a_VolumetricBudget.txt 
   PRINT_HEAD   NPER       ./output/owhm_v1_example_a_Head.txt
   CUMULATIVE_HEAD_CHANGE  ./output/owhm_v1_example_a_CumHCHG.txt  
END OPTIONS
constant 1
constant 1
constant 1
