...
BEGIN OPTIONS
   ...
   NOCBC
   BUDGETDB                ./output/SWRSample02_VolumetricBudget.txt  
   PRINT_HEAD   NPER       ./output/SWRSample02_Head.txt
   CUMULATIVE_HEAD_CHANGE  ./output/SWRSample02_CumHCHG.txt  
END OPTIONS
#
CONSTANT         1 (25I3)                      -1     # IBOUND Layer   1
9.9900e+02
CONSTANT     4.500 (10e12.4)                    0     # STARTING HEADS Layer   1
