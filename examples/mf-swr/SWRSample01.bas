...
BEGIN OPTIONS
   ...
   NOCBC
   BUDGETDB                EXTERNAL 500    # SWRSample01xxx_VolumetricBudget.txt  
   PRINT_HEAD   NPER       EXTERNAL 510    # SWRSample01xxx_Head.txt
   CUMULATIVE_HEAD_CHANGE  EXTERNAL 520    # SWRSample01xxx_CumHCHG.txt  
END OPTIONS
#
CONSTANT         1  (25I3)                      -1     # IBOUND Layer   1
9.9900e+02
CONSTANT     2.000  (10e12.4)                   -1     # STARTING HEADS Layer   1
