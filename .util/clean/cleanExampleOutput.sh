...
touch ../../examples/mf-owhm/0_Base/output/owhm_0_bas_CumHCHG.txt
touch ../../examples/mf-owhm/1_GHB/output/owhm_1_ghb_CumHCHG.txt
touch ../../examples/mf-owhm/2_FMP/output/owhm_2_fmp_CumHCHG.txt
touch ../../examples/mf-owhm/3_SFR/output/owhm_3_sfr_CumHCHG.txt

touch ../../examples/mf-owhm-gmg/output/owhm_gmg_CumHCHG.txt
...
${FND} ../../examples/mf-owhm-gmg/output   -not -name 'output' -not -name '.keep' -delete
