...
MODULE GENERIC_BLOCK_READER_INSTRUCTION!, ONLY: GENERIC_BLOCK_READER
  USE CONSTANTS,                      ONLY: BLNK,BLN,NL,TAB,COM,Z,ONE,TWO,TEN,DZ,UNO,DOS,DIEZ,TRUE,FALSE, ASCII_DIFF
  ...
  ! -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  !
  PURE SUBROUTINE UPPER(LN)               !UPPER only for internal use to MODULE GENERIC_BLOCK_READER_INSTRUCTION --> coerce compiler to inline calls in module 
