...
!      IF ( GSFLOW_flag > 0 ) GSFLOW_flag_local = GSFLOW_flag
      ...
      WRITE (IOUT, 1) IN
1     FORMAT(1X, /1X, 'AG -- AG PACKAGE FROM MF-NWT',
...
!     +  , ' SET EQUAL TO.', F10.3)
      ...
      REAL :: R, TTIME, TRATE
      CHARACTER(6) CWELL
      CHARACTER(20),DIMENSION(1):: AGYGROUP
C     ------------------------------------------------------------------
      AGYGROUP='NOGROUP'
      ! - -----------------------------------------------------------------
      found4 = .false.
...
!
     ...
     +             TEXT5
      ...
      DOUBLE PRECISION :: DONENEG
      TEXT1  = '           AG WELLS'
      TEXT2  = '  DIVERSION SEGMENTS'
      TEXT3  = '       SW IRRIGATION'
      TEXT4  = '       GW IRRIGATION'
      TEXT5  = '       SW RETURN FLOW'
      TEXT6  = '       GW RETURN FLOW'
      TEXT7  = '    SYSTEM LOSSES SW'
      TEXT8  = '    SYSTEM LOSSES GW'
      TEXT9  = '       AG WELLS'
      TEXT10 = 'CROP CONSUMPTION SW'
      TEXT11 = 'CROP CONSUMPTION GW'
      ! - -----------------------------------------------------------------
      ZERO = 0.0D0
      DONE = 1.0D0
      DONENEG = -1.0D0
