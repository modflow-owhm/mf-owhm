...
C2A------READ FIRST RECORD AND WRITE
     ...
     +                          HED="-- READING HUF PACKAGE INPUT --")
      ...
      CALL CHECK_CBC_GLOBAL_UNIT(IHUFCB, .TRUE.)
      !
...
C     ------------------------------------------------------------------
      USE GLOBAL,      ONLY:NCOL,NROW,NLAY,IBOUND,HNEW,BUFF,CR,CC,CV,
     1                      BOTM,LBOTM,IOUT, KND, NO_CONST_HEAD
...
C5------IF SO THEN CALL ULASAV OR ULASV2 TO SAVE HEAD.
   ...
   74       FORMAT(1X,/1X,'HEAD IN HYDROGEOLOGIC UNITS WILL BE SAVED ',
     &      'ON UNIT ',I4,' AT END OF TIME STEP',I3,' IN STRESS PERIOD',
     &        I3)
