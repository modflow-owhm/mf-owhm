     ...
     1                           NFHBX2,IFHBSS
      ...
      SUBROUTINE GET_FHB_UNIT(LINE, IN, LLOC, IU)
      IMPLICIT NONE
      CHARACTER(*):: LINE
      INTEGER:: IN, LLOC, IU
...
C1------IDENTIFY PACKAGE
        WRITE(IOUT,1)IN
    1 FORMAT(1X,/1X,'FHB1 -- SPECIFIED FLOW PACKAGE, VERSION OWHM',
     &' INPUT READ FROM',I3)
C
...
C2------AUXILIARY VARIABLES.
     ...
     +                          HED="-- READING FHB PACKAGE INPUT --")
      ...
      CALL CHECK_CBC_GLOBAL_UNIT(IFHBCB, .FALSE.)
      !
C
...
C1------READ TIMES AT WHICH SPECIFIED FLOW AND HEAD VALUES WILL BE READ
      CALL READ_TO_DATA(LINE,IN,IOUT)
      CALL GET_FHB_UNIT(LINE, IN, LLOC, IFHBUN)
...
C     ------------------------------------------------------------------
      ...
      USE GWFFHBMODULE,ONLY:NBDTIM,NFLW,NHED,NFHBX1,NFHBX2,
     1                      IFHBSS,IHDLOC,BDTIM,FLWRAT,SBHED,
     2                      BDFV,BDHV,FHBXWT
C     ------------------------------------------------------------------
...
C     ------------------------------------------------------------------
     ...
     1                      IAUXSV
      USE GWFFHBMODULE,ONLY:NFLW,IFHBCB,IFLLOC,BDFV
C
      CHARACTER(16) TEXT
