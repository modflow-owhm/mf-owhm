      MODULE GWFSFRMODULE
        ...
        TYPE(GENERIC_OUTPUT_FILE),      POINTER,SAVE::SFR_SEG_FRES
        INTEGER,                        POINTER,SAVE::SFR_SEG_FRES_OUTER
      ...
      TYPE GWFSFRTYPE
        ...
        TYPE(GENERIC_OUTPUT_FILE),      POINTER::SFR_SEG_FRES
        INTEGER,                        POINTER::SFR_SEG_FRES_OUTER
