...
C
      ...
      INTEGER I,J,K,ll,IR,IC,IL,KPER,KSTP,ILMTFMT,IUMT3D,ISSMT3D,IGRID
...
C
      ...
      IGWET          => LMTDAT(IGRID)%IGWET  
      IUZFRCH        => LMTDAT(IGRID)%IUZFRCH    
      RETURN
      END
C***********************************************************************
...
C
      ...
      LMTDAT(IGRID)%IGWET          => IGWET  
      LMTDAT(IGRID)%IUZFRCH        => IUZFRCH
C
      RETURN
      END
C***********************************************************************
...
C
      ...
      DEALLOCATE(LMTDAT(IGRID)%IGWET         , STAT=IERR)
      DEALLOCATE(LMTDAT(IGRID)%IUZFRCH       , STAT=IERR)
C
C
