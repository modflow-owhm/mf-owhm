...
C     ------------------------------------------------------------------
     ...
     1                      CC,CV,IFREFM,KND,BOTM !swm: added BOTM
...
C     ------------------------------------------------------------------
      AVGNAM(1) = 'HARMONIC    '
      AVGNAM(2) = 'ARITHMETIC  '
      AVGNAM(3) = 'LOGARITHMIC '
      AVGNAM(4) = '*UNCONFINED*'
C
      ANAME(1) = '    PRIMARY STORAGE COEF'
      ANAME(2) = '    TRANSMIS. ALONG ROWS'
      ANAME(3) = '   HYD. COND. ALONG ROWS'
      ANAME(4) = 'VERT HYD COND /THICKNESS'
      ANAME(5) = '  SECONDARY STORAGE COEF'
      ANAME(6) = 'COLUMN TO ROW ANISOTROPY'
      ANAME(7) = '        WETDRY PARAMETER'
C     ------------------------------------------------------------------
...
C
     ...
     +          BACK_UP=.TRUE., HED="-- READING BCF PACKAGE INPUT --")
C
...
C3------(HEAD AT CELLS THAT CONVERT TO DRY), AND WETTING PARAMETERS.
      IF(NOFREE) THEN
         READ(IN,'(I10,F10.0,I10)')
     1              IBCFCB,HDRY,IWDFLG
      ELSE
         READ(IN,*) IBCFCB,HDRY,IWDFLG
      END IF
     ...
     1                  IBCFCB,HDRY,IWDFLG,WETFCT,IWETIT,IHDWET
      ...
      CALL CHECK_CBC_GLOBAL_UNIT(IBCFCB, .TRUE.)
      !
C
