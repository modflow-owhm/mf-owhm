...
MODULE WBS_DATA_FMP_MODULE
  ...
  SUBROUTINE INITIALIZE_WBS_DATA( BL, WBS, LINE, FDIM )  
    ...
    CHARACTER(5):: ERROR
    LOGICAL:: EOF
    INTEGER:: I, LLOC, ISTART, ISTOP, IU, NIRRG, NCROP
    ...
    IF(FDIM%NFARM < ONE) THEN
        CALL WARNING_MESSAGE(OUTPUT=BL%IOUT,MSG='FMP WBS BLOCK: THE GLOBAL DIMENSION BLOCK SPECIFIED NWBS WITH A VALLUE LESS THAN 1.'//NL// &
