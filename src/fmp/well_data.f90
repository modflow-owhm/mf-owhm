...
!  END SUBROUTINE
  ...
  SUBROUTINE FWEL_LOAD_LIST(BL,FWEL,INSTYLE)
    ...
    INTEGER:: LLOC, NF, IL,IR,IC, NFARM, SPSTART, SPEND,ISTART,ISTOP
    ...
    DO I=ONE, NFILE
       ...
       DO J=ONE, BL%NLINE !BL%LIST%GETPOS()
           ...
           ! Check for index errors
           if (NF < ONE .or. NFARM < NF) CYCLE
           !!!if (LAY < ONE .or. NFARM < LAY) CYCLE
           !!!if (ROW < ONE .or. NFARM < ROW) CYCLE
           !!!if (NF < COL .or. NFARM < COL) CYCLE
           !
