...
MODULE SALINITY_DATA_FMP_MODULE!, ONLY: SALINITY_DATA, INITIALIZE_SALINITY_DATA
  ...
  END SUBROUTINE
  !
  SUBROUTINE PRINT_OUT_BYFARM(SALT,CDAT, WBS, KPER, KSTP, DELT, DYEAR, DATE, SET_HEADER)
    CLASS(SALINITY_DATA), INTENT(INOUT):: SALT
    CLASS(CROP_DATA),     INTENT(IN   ):: CDAT
    TYPE(WBS_DATA),       INTENT(IN   ):: WBS
    ...
    !
    IF( SET_HEADER .OR. SALT%IOUT==IU )  THEN
  ...
  END SUBROUTINE
  !
  SUBROUTINE PRINT_OUT_BYFARM_BYCROP(SALT, CDAT, WBS, KPER, KSTP, DELT, DYEAR, DATE, SET_HEADER)
    CLASS(SALINITY_DATA), INTENT(INOUT):: SALT
    CLASS(CROP_DATA),     INTENT(IN   ):: CDAT
    TYPE(WBS_DATA),       INTENT(IN   ):: WBS
    INTEGER,              INTENT(IN   ):: KPER, KSTP
  ...
  END SUBROUTINE
  !
  SUBROUTINE PRINT_OUT_ALL_CROP(SALT,CDAT, WBS, KPER, KSTP, DELT, DYEAR, DATE, SET_HEADER)
    CLASS(SALINITY_DATA), INTENT(INOUT):: SALT
    CLASS(CROP_DATA),     INTENT(IN   ):: CDAT
    TYPE(WBS_DATA),       INTENT(IN   ):: WBS
    INTEGER,              INTENT(IN   ):: KPER, KSTP
