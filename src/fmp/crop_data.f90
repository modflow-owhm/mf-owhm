...
MODULE CROP_DATA_FMP_MODULE
  ...
  TYPE CROP_DATA
      ...
      PROCEDURE, PASS(CDAT):: PRINT_OUT_BYFARM!(WBS, KPER, KSTP, DELT, DYEAR, DATE, SET_HEADER)
      PROCEDURE, PASS(CDAT):: PRINT_OUT_BYCROP!(WBS, KPER, KSTP, DELT, DYEAR, DATE, SET_HEADER)
      PROCEDURE, PASS(CDAT):: PRINT_OUT_DETAIL_CROP!(WBS, KPER, KSTP, DELT, DYEAR, DATE, SET_HEADER)
      PROCEDURE, PASS(CDAT):: PRINT_OUT_BARE!(WBS, KPER, KSTP, DELT, DYEAR, DATE, SET_HEADER)
      PROCEDURE, PASS(CDAT):: PRINT_OUT_INPUT!(WBS, KPER, KSTP, SET_HEADER)
  ...
  SUBROUTINE INITIALIZE_CROP_DATA( BL, CDAT, LINE, FDIM, HAS_SFR )  !NFARM, IFID
    ...
    CHARACTER(5):: ERROR
    LOGICAL:: EOF
    INTEGER:: I, LLOC, ISTART, ISTOP, IU, NROW, NCOL, ELV_NROW, PAD, NPRNT_CROP, NFARM
    ...
    DO WHILE (.NOT. EOF)
      ...
      CASE ("LAND_USE_AREA_FRACTION")
                        ...
                        IF(CDAT%MULTI_CROP_CELLS) THEN
                            ...
                            CALL CDAT%FRAC%INIT('MULTI_FRAC', LLOC, LINE, BL%IOUT, BL%IU,          Z,   Z, NROW, NCOL, NFARM, BYFARM, CDAT%NCROP, BYCROP, SCRATCH=BL%SCRATCH, CDIM=CDIM)
                        ELSE
                            ...
                            CALL CDAT%FRAC%INIT('SINGLE_FRAC', LLOC, LINE, BL%IOUT, BL%IU, CDAT%NCROP, ONE, NROW, NCOL, NFARM, BYFARM, CDAT%NCROP, BYCROP, SCRATCH=BL%SCRATCH, CDIM=CDIM)
                        END IF
      ...
      CASE ("ROOT","ROOT_DEPTH","ROOT_PRESSURE") !ALLOW FOR SPACE BETWEEN ROOT DEPTH AND ROOT PRESSURE
                        ...
                        CASE('DEPTH',"ROOT_DEPTH")
                                        ...
                                        CALL CDAT%ROOT%INIT('ROOT',     LLOC, LINE, BL%IOUT, BL%IU, CDAT%NCROP, ONE, NROW, NCOL, NFARM, BYFARM, CDAT%NCROP, BYCROP,CDAT%NIRRG, BYIRRIGATE, SCRATCH=BL%SCRATCH, CDIM=CDIM, NONEG=TRUE)
                                        !CALL CDAT%ROOT%NEXT()
      ...
      CASE ("CROP_COEFFICIENT", "CROP_COEFICIENT")
                        ...
                        CALL CDAT%Kc%INIT('Kc',         LLOC, LINE, BL%IOUT, BL%IU, CDAT%NCROP, ONE, NROW, NCOL, NFARM, BYFARM, CDAT%NCROP, BYCROP,CDAT%NIRRG, BYIRRIGATE, SCRATCH=BL%SCRATCH, CDIM=CDIM) !, NONEG=TRUE)
                        CDAT%HAS_Kc = TRUE
                        !
      CASE ("CONSUMPTIVE_USE")
                        ...
                        CALL CDAT%CF%INIT('CF',         LLOC, LINE, BL%IOUT, BL%IU, CDAT%NCROP, ONE, NROW, NCOL, NFARM, BYFARM, CDAT%NCROP, BYCROP,CDAT%NIRRG, BYIRRIGATE, SCRATCH=BL%SCRATCH, CDIM=CDIM) !, NONEG=TRUE)
                        !
                        !
      ...
      CASE ("NO_TPOT_SHIFT_TO_EPOT")
                        WRITE(BL%IOUT,'(A)') '   NO_TPOT_SHIFT_TO_EPOT                KEYWORD FOUND. UNUSED POTENTIAL TRANSPIRATION WILL NOT BE ADDED TO POTENTIAL EVAPORATION.'
                        CDAT%TPOT_SHIFT_EPOT = FALSE
                        !
      ...
      CASE ("TRANSPIRATION_FRACTION","FTR")
                        ...
                        CALL CDAT%FTR%INIT('FTR',       LLOC, LINE, BL%IOUT, BL%IU, CDAT%NCROP, ONE, NROW, NCOL, NFARM, BYFARM, CDAT%NCROP, BYCROP,CDAT%NIRRG, BYIRRIGATE, SCRATCH=BL%SCRATCH, CDIM=CDIM)
                        !
      CASE ("EVAPORATION_IRRIGATION_FRACTION","FEI")
                        ...
                        IF(CDAT%NIRRG > Z) THEN
                           ...
                           CASE('BYIRRIGATE', 'BY_IRRIGATE','BYIRRIGATION',"BY_IRRIGATION")
                                           ...
                                           CALL CDAT%FEI%INIT('FEI_BYIRR',      LLOC, LINE, BL%IOUT, BL%IU, CDAT%NIRRG, ONE, NROW, NCOL, NFARM, BYFARM, CDAT%NCROP, BYCROP,CDAT%NIRRG, BYIRRIGATE, SCRATCH=BL%SCRATCH, CDIM=CDIM)
                           CASE('BYCROP',"BY_CROP")
                                           ...
                                           CALL CDAT%FEI%INIT('FEI_BYCROP',      LLOC, LINE, BL%IOUT, BL%IU, CDAT%NCROP, ONE, NROW, NCOL, NFARM, BYFARM, CDAT%NCROP, BYCROP,CDAT%NIRRG, BYIRRIGATE, SCRATCH=BL%SCRATCH, CDIM=CDIM)
                           CASE DEFAULT
                        ...
                        !!!IF(CDAT%NIRRG > Z) THEN
                        !!!    CALL CDAT%FEI%INIT('FEI',       LLOC, LINE, BL%IOUT, BL%IU, CDAT%NCROP, ONE, NROW, NCOL, NFARM, BYFARM, CDAT%NCROP, BYCROP,CDAT%NIRRG, BYIRRIGATE, SCRATCH=BL%SCRATCH, CDIM=CDIM)
                        !!!ELSE
                        !!!    CALL WARNING_MESSAGE(OUTPUT=CDAT%LOUT,MSG='FMP CROP BLOCK: FOUND KEYWORD "EVAPORATION_IRRIGATION_FRACTION" WHEN NIRRIGATE = 0. THIS LINE WILL BE IGNORED AND THE EVAPORATION_IRRIGATION_FRACTION SET TO 0.0 FOR ALL CROPS.',CMD_PRINT=TRUE)
                        !!!END IF
                        !
      ...
      CASE ("SURFACEWATER_LOSS_FRACTION_PRECIPITATION","FIESWP")
                        ...
                        CALL CDAT%FIESWP%INIT('FIESWP', LLOC, LINE, BL%IOUT, BL%IU, CDAT%NCROP, ONE, NROW, NCOL, NFARM, BYFARM, CDAT%NCROP, BYCROP, SCRATCH=BL%SCRATCH, CDIM=CDIM, NONEG=TRUE)
                        !
      CASE ("SURFACEWATER_LOSS_FRACTION_IRRIGATION","FIESWI")
                        ...
                        IF(CDAT%NIRRG > Z) THEN
                           ...
                           CASE('BYIRRIGATE', 'BY_IRRIGATE','BYIRRIGATION',"BY_IRRIGATION")
                                           ...
                                           CALL CDAT%FIESWI%INIT('FIESWI_BYIRR', LLOC, LINE, BL%IOUT, BL%IU, CDAT%NIRRG, ONE, NROW, NCOL, NFARM, BYFARM, CDAT%NCROP, BYCROP,CDAT%NIRRG, BYIRRIGATE, SCRATCH=BL%SCRATCH, CDIM=CDIM)
                           CASE('BYCROP',"BY_CROP")
                                           ...
                                           CALL CDAT%FIESWI%INIT('FIESWI_BYCROP', LLOC, LINE, BL%IOUT, BL%IU, CDAT%NCROP, ONE, NROW, NCOL, NFARM, BYFARM, CDAT%NCROP, BYCROP,CDAT%NIRRG, BYIRRIGATE, SCRATCH=BL%SCRATCH, CDIM=CDIM)
                           CASE DEFAULT
      ...
      !!!                                  WRITE(BL%IOUT,'(3x,4A)') LINE(ISTART:ISTOP),' KEYWORD FOUND, SO IF USING LIST STYLE FOR SURFACEWATER_LOSS_FRACTION_IRRIGATION (FIESWI), THEN IT WILL EXPECT TO LOAD ', NUM2STR(CDAT%NIRRG), ' (NIRRIGATE) RECORDS.'
      !!!                                  CALL CDAT%CON_PRECIP_FRAC%INIT('PCF', LLOC, LINE, BL%IOUT, BL%IU, CDAT%NCROP, ONE, NROW, NCOL, NFARM, BYFARM, CDAT%NCROP, BYCROP,CDAT%NIRRG, BYIRRIGATE, SCRATCH=BL%SCRATCH, CDIM=CDIM, NONEG=TRUE)
      ...
      CASE ("POND_DEPTH")
                        ...
                        CDAT%HAS_POND = TRUE
                        CALL CDAT%POND%INIT('POND',     LLOC, LINE, BL%IOUT, BL%IU, CDAT%NCROP, ONE, Z, Z, NFARM, BYFARM, CDAT%NCROP, BYCROP,CDAT%NIRRG, BYIRRIGATE, SCRATCH=BL%SCRATCH, NONEG=TRUE)
                        !
      ...
      CASE ("CROP_SURFACE_ELEVATION")
                        ...
                        !
                        CALL CDAT%SPEC_GSE%INIT('GSE_SPEC',LLOC, LINE, BL%IOUT, BL%SCRATCH, Z, Z, ELV_NROW, NCOL, NFARM, BYFARM, CDAT%NCROP, BYCROP, SCRATCH=BL%SCRATCH, NO_TRANSIENT=TRUE)
                        !
      CASE ("CROP_SURFACE_ELEVATION_OFFSET")
                        ...
                        !
                        CALL CDAT%GSE_OFFSET%INIT('GSE_OFFSET',LLOC, LINE, BL%IOUT, BL%SCRATCH, CDAT%NCROP_ELEV, ONE, Z, Z, NFARM, BYFARM, CDAT%NCROP, BYCROP, SCRATCH=BL%SCRATCH, NO_TRANSIENT=TRUE)
                        !
    ...
    END IF
    !
    IF(.NOT. CDAT%ROOT%INUSE .AND. CDAT%GW_ROOT_INTERACTION)  CALL WARN%ADD(NL//'FMP CROP ERROR. THERE IS INTERACTION BETWEEN THE THE CROP ROOTS AND GROUNDWATER LEVEL TO CALCULATE TRANSPIRATION (DEFAULT BEHAIVOR).'//NL//'THIS REQUIRES THE CROP ROOT DEPTH TO BE SPECIFIED WITH "ROOT DEPTH" OR "ROOT_DEPTH" KEYWORD IN CROP BLOCK.'//NL//'EITHER SPECIFY ROOT DEPTHS OR USE KEYWORD "GROUNDWATER_ROOT_INTERACTION"'//NL//'AND SET ALL VALUES TO ONE TO DISABLE ANY GROUNDWATER ROOT INTERACTION'//NL//'(THUS NEGATING THE NEED FOR SPECIFYING ROOT DEPTHS).'//NL)
    !
    ...
    IF( .NOT. CDAT%FIESWP%INUSE )                          CALL WARN%ADD(NL//'FMP CROP BLOCK: FAILED TO LOCATE "SURFACEWATER_LOSS_FRACTION_PRECIPITATION" (OR "FIESWP") KEYWORD IN CROP BLOCK, IT WILL BE AUTOMATICALLY SET TO 0.8 FOR ALL CROPS, IF SFR IS NOT AVAILIBLE THEN IT WILL BE AUTOMATICALLY SET TO 0.0 (IF SFR := FIESWP=0.8, ELSE FIESWP=0.0)'//NL)
    !
    ...
    IF( .NOT.       CDAT%FTR%INUSE ) CALL CDAT%FTR%INIT('FTR', DZ, BL%IOUT, BL%IU, CDAT%NCROP, ONE, Z, Z)
    !    
    ...
    IF(.NOT.       CDAT%ADMD%INUSE ) THEN
                            CALL CDAT%ADMD%INIT('ADMD', DZ, BL%IOUT, BL%IU, CDAT%NCROP, NFARM, Z, Z, LISTARRAY=TRUE)
                            CDAT%DEMAND_EXT_FLUX = FALSE
    END IF
    !
  ...
  SUBROUTINE SETUP_DEPENDENT_PARTS(CDAT, FDIM, WBS, CLIM, SOIL, IOUT )
    ...
    !
    CDAT%CHECK_BARE = CLIM%HAS_BARE_PET
    !
    IF( CDAT%NCROP == Z) THEN
        !
  ...
  SUBROUTINE SETUP_NEXT_STRESS_PERIOD(CDAT, WBS, CLIM, SOIL, LOAD)
    ...
    ELSE!--------------------------------------------------------------------------------------------------------------------------------
        ...
        ELSE
            ...
            IF (CDAT%MULTI_CROP_CELLS .AND. .NOT.CLIM%HAS_BARE_PET)  CALL STOP_ERROR(OUTPUT=CDAT%LOUT,MSG='FMP CROP ERROR. CROP BLOCK SPECIFIED KEYWORD "FRACTION" WHICH REQUIRES THAT THE CLIMATE BLOCK SPECIFY EITHER A THE KEYWORD "REFERENCE_ET" OR "POTENTIAL_EVAPORATION_BARE" SO THAT EVAPORATION OF PRECIPITATION AND/OR GROUNDWATER OVER BARE/FALLOW LAND CAN BE CALCULATED.')
            !
            IF(CDAT%MIN_BARE > NEAR_inf .AND. CLIM%HAS_BARE_PET) THEN
            ...
            IF(.NOT. WBS%ADRF_TFR%INUSE .AND. CDAT%NIRRG > Z .AND. (CDAT%HAS_DEMAND_EXT .OR. WBS%HAS_CROP_FLUX .OR. WBS%HAS_CROP_VOLR)) CALL WARNING_MESSAGE(OUTPUT=CDAT%LOUT,MSG='FMP WBS BLOCK FAILED TO LOCATE KEYWORD "ADDED_DEMAND_RUNOFF_SPLIT" WHEN THERE IS ADDED_DEMAND/ADDED_CROP_DEMAND SPECIFIED.'//NL//'THIS FRACTION IS THE SPLIT OF RUNOFF TO DEEP PERCOLATION OF ANY ADDITIONAL DEMAND SPECIFIED FOR CROPS.'//NL//'THE SPLIT IS AUTOMATICALLY SET TO 0.1 (10% BECOMES RUNOFF AND 90% DEEP PERCOLATION) FOR ALL WBS (FARMS) AND IRRIGATION TYPES.'//BLN, INLINE=TRUE)
            !
            CDAT%TFR_READ = TRUE
            UPDATE        = TRUE
            LOAD_NEXT     = TRUE
            ...
            !
            IF( CDAT%TPOT_SHIFT_EPOT ) CDAT%TPOT_SHIFT_EPOT = CLIM%TPOT_SHIFT_EPOT
            !
        END IF
        !
        ...
        IF(UPDATE) THEN
            ...
            IF(.NOT. CDAT%MULTI_CROP_CELLS .AND. .NOT. CLIM%HAS_BARE_PET) THEN
                !
            ...
            IF(.NOT. CDAT%ROOT%INUSE .AND. CDAT%GW_ROOT_INTERACTION)  THEN  !CHECK IF ROOT DEPTH IS REQUIRED
                IF(CDAT%HAS_PSI) THEN
                    ERROR = 'FMP CROP ERROR. THERE IS INTERACTION BETWEEN THE THE CROP ROOTS AND GROUNDWATER LEVEL TO CALCULATE TRANSPIRATION (DEFAULT BEHAIVOR).'//NL// &
                            ...
                            'THIS REQUIRES THE CROP ROOT DEPTH TO BE SPECIFIED WITH "ROOT DEPTH" OR "ROOT_DEPTH" KEYWORD IN CROP BLOCK FOLLOWED BY EACH CROPS ROOT DEPTH THAT IS GREATER THAN ZERO (>0).'//NL// &
        ...
        IF (UPDATE .OR. ((CDAT%Kc%TRANSIENT .OR. CDAT%CF%TRANSIENT) .AND. LOAD_NEXT) .OR. CLIM%REF_ET_TFR%TRANSIENT .OR. CLIM%REF_ET_BARE_TFR%TRANSIENT .OR. (NEW_IRR .AND. CDAT%Kc%SFAC%HAS_EX3) .OR. (NEW_IRR .AND. CDAT%CF%SFAC%HAS_EX3) ) THEN
            ...
            ELSEIF (CDAT%Kc%INUSE) THEN
                  ...
                  DO CONCURRENT ( K=ONE:CDAT%CROP(I)%N ) !  CU + Kc * Area* ETR
                                                    ...
                                                    END IF   
                  END DO; END DO
            ELSEIF(CLIM%HAS_BARE_PET .AND. CDAT%ZERO_CU_TO_BARE%INUSE) THEN
                  DO CONCURRENT (I=ONE:CDAT%NCROP)
          ...
          IF(UPDATE .OR. WBS%ADRF_TFR%TRANSIENT .OR. (NEW_IRR .AND. WBS%ADRF_TFR%SFAC%HAS_EX3)) THEN
                    ...
                    IF (WRN%RAISED) CALL WRN%CHECK(HED='FMP CROP WARNING ADDITIONAL_IRRIGATION_RUNOFF_FRACTION > 1.0, '//NL//'ADDITIONAL_IRRIGATION_RUNOFF_FRACTION RESET TO 1.0'//BLN// &
                                                       ' CROP_ID  WBS      IRR      ROW      COLUMN',                   &
                                                        OUTPUT=CDAT%LOUT, TAIL=NL, NO_NL=TRUE, INIT=TRUE)
          END IF
        !ELSEIF(UPDATE) THEN ! Allocated at 0.1 so no need to reset to 0.1
        ...
        IF (UPDATE .AND. CDAT%MIN_BARE < UNO) THEN
              ...
              END IF
              !
              IF(CLIM%HAS_BARE_PET) THEN
                                           CDAT%CHECK_BARE = ANY(CDAT%BARE_FRAC > DZ)
              ELSE
                                           CDAT%CHECK_BARE = FALSE
              END IF
              !
        ELSEIF(UPDATE .AND. CLIM%HAS_BARE_PET) THEN
              DO CONCURRENT ( R=ONE:CDAT%NROW, C=ONE:CDAT%NCOL)   
                  IF(WBS%FID_ARRAY(C,R) < ONE) THEN             ! No WBS no Sim
                      CDAT%BARE_FRAC(C,R) = DZ
                  ELSEIF(CDAT%CRPID(C,R) > Z) THEN              ! Has Crop Defined, so No Bare
                      CDAT%BARE_FRAC(C,R) = DZ
                  ELSE
                      CDAT%BARE_FRAC(C,R) = UNO
                  END IF
              END DO
              CDAT%CHECK_BARE = ANY(CDAT%BARE_FRAC > DZ)
        END IF
  ...
  END SUBROUTINE
  !
  SUBROUTINE PRINT_OUT_ET(CDAT, WBS, CLIM, KPER, KSTP, DELT, DYEAR, DATE, SET_HEADER)
    CLASS(CROP_DATA),   INTENT(INOUT):: CDAT
    TYPE(WBS_DATA),     INTENT(IN   ):: WBS
    TYPE(CLIMATE_DATA), INTENT(IN   ):: CLIM
    ...
    IU = CDAT%OUT_ET%IU
    !
    IF( SET_HEADER .OR. CDAT%IOUT==IU )  THEN
        ...
        IF(CDAT%FRAC%HAS_IXJ) THEN
          ...
          ASSOCIATE(DIM => CDAT%FRAC%IXJ%N, POS=>CDAT%FRAC%IXJ%P, DAT => CDAT%FRAC%IXJ%DAT)
             ...
             DO ID=ONE, CDAT%NCROP
                ...
                M   = Z  ! TOTAL COUNT OF CROP ID ASSOCIATED WITH A WBS
                !
                DO P=ONE, DIM
                ...
                IF( N > Z) THEN 
                               ...
                               !
                               K = Z
                               DO WHILE (POS <= DIM)  ! Continue until crop ID is not found in the IXJ list
                                   I = DAT(POS)%I(2) 
                                   J = DAT(POS)%I(3)
...
!    END SUBROUTINE
  ...
  END SUBROUTINE
  !
  SUBROUTINE PRINT_OUT_BYFARM(CDAT, WBS, KPER, KSTP, DELT, DYEAR, DATE, SET_HEADER)
    CLASS(CROP_DATA),INTENT(INOUT):: CDAT
    TYPE(WBS_DATA),  INTENT(IN   ):: WBS
    INTEGER,         INTENT(IN   ):: KPER, KSTP
    DOUBLE PRECISION,INTENT(IN   ):: DELT
  ...
  END SUBROUTINE
  !
  SUBROUTINE PRINT_OUT_BYCROP(CDAT, WBS, KPER, KSTP, DELT, DYEAR, DATE, SET_HEADER)
    CLASS(CROP_DATA),INTENT(INOUT):: CDAT
    TYPE(WBS_DATA),  INTENT(IN   ):: WBS
    INTEGER,         INTENT(IN   ):: KPER, KSTP
    DOUBLE PRECISION,INTENT(IN   ):: DELT
  ...
  END SUBROUTINE
  !
  SUBROUTINE PRINT_OUT_BYFARM_BYCROP(CDAT, WBS, KPER, KSTP, DELT, DYEAR, DATE, SET_HEADER)
    CLASS(CROP_DATA),INTENT(INOUT):: CDAT
    TYPE(WBS_DATA),  INTENT(IN   ):: WBS
    INTEGER,         INTENT(IN   ):: KPER, KSTP
    DOUBLE PRECISION,INTENT(IN   ):: DELT
  ...
  END SUBROUTINE
  !
  SUBROUTINE PRINT_OUT_SPECIFIED(CDAT, WBS, KPER, KSTP, DELT, DYEAR, DATE, SET_HEADER)
    CLASS(CROP_DATA),INTENT(INOUT):: CDAT
    TYPE(WBS_DATA),  INTENT(IN   ):: WBS
    INTEGER,         INTENT(IN   ):: KPER, KSTP
    DOUBLE PRECISION,INTENT(IN   ):: DELT
  ...
  END SUBROUTINE
  !
  SUBROUTINE PRINT_OUT_ALL_CROP(CDAT, WBS, KPER, KSTP, DELT, DYEAR, DATE, SET_HEADER)
    CLASS(CROP_DATA),INTENT(INOUT):: CDAT
    TYPE(WBS_DATA),  INTENT(IN   ):: WBS
    INTEGER,         INTENT(IN   ):: KPER, KSTP
    DOUBLE PRECISION,INTENT(IN   ):: DELT
  ...
  END SUBROUTINE
  !
  SUBROUTINE PRINT_OUT_DETAIL_CROP(CDAT, WBS, KPER, KSTP, DELT, DYEAR, DATE, SET_HEADER)
    CLASS(CROP_DATA),INTENT(INOUT):: CDAT
    TYPE(WBS_DATA),  INTENT(IN   ):: WBS
    INTEGER,         INTENT(IN   ):: KPER, KSTP
    DOUBLE PRECISION,INTENT(IN   ):: DELT
  ...
  END SUBROUTINE
  !
  SUBROUTINE PRINT_OUT_INPUT(CDAT, WBS, KPER, KSTP, SET_HEADER)
    CLASS(CROP_DATA),INTENT(INOUT):: CDAT
    TYPE(WBS_DATA),  INTENT(IN   ):: WBS
    INTEGER,         INTENT(IN   ):: KPER, KSTP
    LOGICAL,         INTENT(IN   ):: SET_HEADER
  ...
  END SUBROUTINE
  !
  SUBROUTINE PRINT_OUT_BARE(CDAT, WBS, KPER, KSTP, DELT, DYEAR, DATE, FRINGE, SET_HEADER)
    CLASS(CROP_DATA),INTENT(INOUT):: CDAT
    TYPE(WBS_DATA),  INTENT(IN   ):: WBS
    INTEGER,         INTENT(IN   ):: KPER, KSTP
    DOUBLE PRECISION,INTENT(IN   ):: DELT
  ...
  END SUBROUTINE
  !
  !SUBROUTINE PRINT_OUT_ROOT(CDAT, WBS, KPER, KSTP, DELT, DYEAR, DATE, SET_HEADER)  --NOT COMPLETE
  !  CLASS(CROP_DATA),INTENT(INOUT):: CDAT
  !  TYPE(WBS_DATA),  INTENT(IN   ):: WBS
  !  INTEGER,         INTENT(IN   ):: KPER, KSTP
  !  REAL,            INTENT(IN   ):: DELT
  ...
  PURE FUNCTION FUNC(X,D,M,N,Y)
    ...
    !
    FUNC = D*((M/D)**(((X-1.D0)/(D-1.D0))**N)) + X - D - Y
    ! 
  END FUNCTION FUNC
  !
