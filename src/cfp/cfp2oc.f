...
C
 ...
 9001 FORMAT ('   TOTIM (T)          HCON', 6X, 'HMAT', 5X,'QDIR', 6X,  !TR: 2012 06 08 WELL / CADS / FHLQ; 2012 11 29 HMAT / 2013 03 14 CAUCHY // 2016 10 11 
     +        'QWELL', 8X,'QMAT',1x,'QCADS<->CON',7X,'QTUB1',           !TR: 2014 02 20 CADS RECHARGE (QSDIR) // 2014 04 15 
!     +       'QTUB5', 9X, 'QTUB6', 9X, 'NSTOR', 10X, 'QFIX', 20(A14))
     +        7X,'QTUB2',7X,'QTUB3',7X,'QTUB4',7X,'QTUB5',7X,'QTUB6',7X,
     +        'NSTOR',8X,'QFIX',8X,'QLH',5X,'FHLQ (LQ)',6X,'CAUCHY',1x,
     +        'CAUCHY (LQ)',1x,'BREAK-DOWN CADS FLOW  QCADS<->CON',4X,   !TR: 2014 04 15 
 ...
 9011 FORMAT ('   TOTIM (T)          HCON', 9X, 'HWELL',6X,'HMAT', 5X,  !TR: 2012 06 08 WELL / CADS / FHLQ; 2012 11 29 HMAT / 2013 03 14 CAUCHY // 2016 10 11 
     +        'QDIR', 6X,'QWELL', 8X,'QMAT',1x,'QCADS<->CON',7X,'QTUB1',!TR: 2014 02 20 CADS RECHARGE (QSDIR) // 2014 04 15 
!     +       'QTUB5', 9X, 'QTUB6', 9X, 'NSTOR', 10X, 'QFIX', 20(A14))
     +        7X,'QTUB2',7X,'QTUB3',7X,'QTUB4',7X,'QTUB5',7X,'QTUB6',7X,
     +        'NSTOR',8X,'QFIX',8X,'QLH',5X,'FHLQ (LQ)',6X,'CAUCHY',1x,
     +        'CAUCHY (LQ)',1x,'BREAK-DOWN CADS FLOW  QCADS<->CON',4X,   !TR: 2014 04 15 
...
! 9002 FORMAT (F14.0, F14.8, 20(G14.6))
 9002 FORMAT (F12.1, F14.8, F10.4, 4(G12.4),1x,6(G11.4,1x),6(G12.4),22x,   !TR: 2012 05 15 FHLQ / WELL; 2012 11 29 HMAT / 2013 03 14 CAUCHY / 2013 03 25 LH // 2014 02 20 CADS RECHARGE
     +        6(G12.4))
 9012 FORMAT (F12.1, F14.8,F14.8,F10.4,4(G12.4),1x,6(G11.4,1x),6(G12.4),!TR: 2012 05 15 FHLQ / WELL; 2012 11 29 HMAT / 2013 03 14 CAUCHY / 2013 03 25 LH // 2014 02 20 CADS RECHARGE
     +        22x,6(G12.4))
C
...
C      
 ...
 9001 FORMAT ('     TOTIM    FIX(IN)     LH(IN)   FHLQ(IN)     ',
     ...
     +        ' PFPS(OUT)  ',' ALL(OUT)')
 9002 FORMAT (F10.0,1x,24(E10.4,1x))          
C
...
C      
 ...
 9011 FORMAT (F10.0,22x,1000(G10.4,1x))          
